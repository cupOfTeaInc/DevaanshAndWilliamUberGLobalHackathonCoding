    ...
    `:i.dy``}},{kind:"method",key:"firstUpdated",value:function(e){ot(st(r.prototype),"firstUpdated",this).call(this,e),this.addEventListener("flow-update",(e=>{const{step:t,stepPromise:r}=e.detail;this._processStep(t||r)}))}},{kind:"method",key:"willUpdate",value:function(e){ot(st(r.prototype),"willUpdate",this).call(this,e),e.has("_step")&&this._step&&(["external","progress"].includes(this._step.type)&&this._subscribeDataEntryFlowProgressed(),"create_entry"===this._step.type&&(this._step.result&&this._params.flowConfig.loadDevicesAndAreas?(this._fetchDevices(this._step.result.entry_id),this._fetchAreas()):(this._devices=[],this._areas=[])))}},{kind:"method",key:"_fetchDevices",value:async function(e){this._unsubDevices=(0,l.q4)(this.hass.connection,(t=>{this._devices=t.filter((t=>t.config_entries.includes(e)))}))}},{kind:"method",key:"_fetchAreas",value:async function(){this._unsubAreas=(0,s.sG)(this.hass.connection,(e=>{this._areas=e}))}},{kind:"method",key:"_checkFlowsInProgress",value:async function(e){this._loading="loading_handlers",this._handler=e;const t=(await(0,a.D7)(this.hass.connection)).filter((t=>t.handler===e));if(t.length)this._step=null,this._flowsInProgress=t;else{let t;this._loading="loading_flow";try{t=await this._params.flowConfig.createFlow(this.hass,e)}catch(e){var r;this.closeDialog();const t=404===(null==e?void 0:e.status_code)?this.hass.localize("ui.panel.config.integrations.config_flow.no_config_flow"):`${this.hass.localize("ui.panel.config.integrations.config_flow.could_not_load")}: ${(null==e||null===(r=e.body)||void 0===r?void 0:r.message)||(null==e?void 0:e.message)}`;return void(0,f.Ys)(this,{title:this.hass.localize("ui.panel.config.integrations.config_flow.error"),text:t})}finally{this._handler=void 0}if(this._processStep(t),void 0===this._params.manifest)try{var i;this._params.manifest=await(0,c.t4)(this.hass,(null===(i=this._params)||void 0===i?void 0:i.domain)||t.handler)}catch(e){this._params.manifest=null}}this._loading=void 0}},{kind:"method",key:"_handlerPicked",value:function(e){this._checkFlowsInProgress(e.detail.handler)}},{kind:"method",key:"_processStep",value:async function(e){if(e instanceof Promise){this._loading="loading_step";try{this._step=await e}catch(e){var t;return this.closeDialog(),void(0,f.Ys)(this,{title:this.hass.localize("ui.panel.config.integrations.config_flow.error"),text:null==e||null===(t=e.body)||void 0===t?void 0:t.message})}finally{this._loading=void 0}}else void 0!==e?(this._step=void 0,await this.updateComplete,this._step=e):this.closeDialog()}},{kind:"method",key:"_subscribeDataEntryFlowProgressed",value:function(){var e,t;this._unsubDataEntryFlowProgressed||(this._unsubDataEntryFlowProgressed=(e=this.hass.connection,t=async e=>{var t,r;e.data.flow_id===(null===(t=this._step)||void 0===t?void 0:t.flow_id)&&this._processStep(this._params.flowConfig.fetchFlow(this.hass,null===(r=this._step)||void 0===r?void 0:r.flow_id))},e.subscribeEvents(t,"data_entry_flow_progressed")))}},{kind:"get",static:!0,key:"styles",value:function(){return[d.yu,i.iv`
      ...
      `},renderShowFormProgressHeader:(e,t)=>e.localize(`component.${t.handler}.config.step.${t.step_id}.title`)||e.localize(`component.${t.handler}.title`),renderShowFormProgressDescription(e,t){const r=e.localize(`component.${t.handler}.config.progress.${t.progress_action}`,t.description_placeholders);return r?i.dy`
          ...
          `:""},renderMenuHeader:(e,t)=>e.localize(`component.${t.handler}.config.step.${t.step_id}.title`)||e.localize(`component.${t.handler}.title`),renderMenuDescription(e,t){const r=e.localize(`component.${t.handler}.config.step.${t.step_id}.description`,t.description_placeholders);return r?i.dy`
            <ha-markdown allowsvg breaks .content=${r}></ha-markdown>
          `:""},renderMenuOption:(e,t,r)=>e.localize(`component.${t.handler}.config.step.${t.step_id}.menu_options.${r}`,t.description_placeholders),renderLoadingDescription(e,t,r,i){if(!["loading_flow","loading_step"].includes(t))return"";const n=(null==i?void 0:i.handler)||r;return e.localize(`ui.panel.config.integrations.config_flow.loading.${t}`,{integration:n?(0,o.Lh)(e.localize,n):e.localize("ui.panel.config.integrations.config_flow.loading.fallback_title")})}})},12343:(e,t,r)=>{r.d(t,{L:()=>o});var i=r(47181);const n=()=>Promise.all([r.e(85084),r.e(44281),r.e(44091),r.e(77576),r.e(29925),r.e(4940),r.e(27829)]).then(r.bind(r,89493)),o=(e,t)=>{(0,i.B)(e,"show-dialog",{dialogTag:"dialog-add-application-credential",dialogImport:n,dialogParams:t})}},70332:(e,t,r)=>{r.d(t,{B:()=>o});var i=r(47181);const n=()=>Promise.all([r.e(29563),r.e(98985),r.e(59799),r.e(6294),r.e(85084),r.e(45507),r.e(71788),r.e(81751)]).then(r.bind(r,81751)),o=(e,t)=>{(0,i.B)(e,"show-dialog",{dialogTag:"dialog-zwave_js-add-node",dialogImport:n,dialogParams:t})}}}]);
//# sourceMappingURL=12f0690a.js.map